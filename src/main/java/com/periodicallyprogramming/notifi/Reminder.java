...
public class Reminder extends ListenerAdapter
{
    ...
    public void onSlashCommandInteraction( @NotNull SlashCommandInteractionEvent event )
    {
        ...
        switch ( event.getSubcommandName() )
        {
            ...
            case ( Commands.NOTIFI_HELP ) ->
            {
                EmbedBuilder builder = new EmbedBuilder()
                        .setTitle( "Notifi Commands" )
                        .setColor( Color.green )
                        .addField( "/notifi new", "Add reminder", false )
                        .addField( "/notifi reset", "Resets all stored reminders", false )
                        .addField( "/notifi list", "Lists all stored eminders", false )
                        .addField( "/notifi delete", "Deletes specified reminder", false )
                        .addField( "/notifi toggle", "Toggles notifications", false );

                event.replyEmbeds( builder.build() ).setEphemeral( true ).queue();
            }
            case ( Commands.NOTIFI_NEW ) ->
            {
